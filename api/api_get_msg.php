...
// }
  ...
  $sql4 = "SELECT b.no,m.img,m.nick,bc.date,bc.content,m.no from blog b JOIN blog_comment_des bcd ON b.no=bcd.blog_no JOIN blog_comment bc ON bcd.blog_comment=bc.no JOIN member m ON m.no=bc.member_no where b.no=:blogNo AND bc.status=1 order by date;"; 
